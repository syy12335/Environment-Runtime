...
class ReplyAgent:
    ...
    def _render_system_prompt(
        ...
        *,
        ...
        rendered = _replace_last(rendered, "{{FINAL_TASK_JSON}}", json.dumps(final_task, ensure_ascii=False, indent=2))
        rendered = _replace_last(rendered, "{{ENVIRONMENT_JSON}}", json.dumps(environment_view, ensure_ascii=False, indent=2))
        return rendered
